...
router.get("/getById/:folderId", jwt.authenticateToken, async (req, res) => {
...
router.get("/getByUserId/:userId", jwt.authenticateToken, async (req, res) => {
...
router.post("/duplicate/:folderId", jwt.authenticateToken, async (req, res) => {
    const { folderId } = req.params;
...
router.post("/copy/:folderId", jwt.authenticateToken, async (req, res) => {
    const { folderId } = req.params;
...
router.delete("/delete/:folderId", jwt.authenticateToken, async (req, res) => {
    const { folderId } = req.params;
